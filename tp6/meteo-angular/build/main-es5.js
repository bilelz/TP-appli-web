...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppServicesMeteoServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _meteoItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../meteoItem */
    "./src/app/meteoItem.ts");
    ...
    function () {
      ...
      _createClass(MeteoService, [{
        ...
        value: function getMeteo(name) {
          ...
          var m = new _meteoItem__WEBPACK_IMPORTED_MODULE_1__["MeteoItem"]();
          return fetch('https://api.openweathermap.org/data/2.5/weather?q=' + name + '&units=metric&lang=fr&appid=8e21ca097f8593edf70ddc460b4b3840').then(function (response) {
            return response.json();
          }).then(function (json) {
            console.log(json); // test du code retour
            // 200 = OK
            // 404 = city not found
        ...
        value: function getFiveDaysForecast(name) {
          console.log('forecast from service', name);
          return fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + name + '&units=metric&lang=fr&appid=8e21ca097f8593edf70ddc460b4b3840').then(function (response) {
            return response.json();
          }).then(function (data) {
            console.log(data); // test du code retour
            // 200 = OK
            // 404 = city not found
            ...
            if (data.cod == 200) {
              ...
              console.error('Forecast introuvable pour ' + name + ' (' + data.message + ')');
              return Promise.reject('forecast introuvable pour ' + name + ' (' + data.message + ')');
            }
          });
        }
      }]);
